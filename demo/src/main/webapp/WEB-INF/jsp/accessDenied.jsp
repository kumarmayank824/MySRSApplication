...
<html ng-app="mainApp">
    <head>
		<title>Unauthorized Access | MyApplication</title>
		<meta charset="UTF-8">
	...
	<body data-ng-controller="mainController">
		...
		<div class="w3-row-padding w3-container" style="padding-top: 200px!important;">
		  <div style="text-align: center;">
		       <h1 class="w3-margin w3-jumbo">You are not authorized to access this page</h1>
		       <a href="/logout" class="w3-button w3-black w3-large">Click! To Logout</a>
		  </div>
		</div>
